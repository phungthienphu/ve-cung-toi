...
function preloadTankSprites() {
  ...
  const srcs = [
    "/tank/Retina/tileGrass1.png",
    "/tank/Retina/tileGrass2.png",
    "/tank/Retina/tileSand1.png",
    "/tank/Retina/tileSand2.png",
    "/tank/Retina/sandbagBeige.png",
    "/tank/Retina/sandbagBrown.png",
    "/tank/Retina/crateWood.png",
    "/tank/Retina/treeGreen_large.png",
    "/tank/Retina/treeGreen_small.png",
    "/tank/Retina/treeBrown_large.png",
    "/tank/Retina/treeGreen_leaf.png",
    "/tank/Retina/treeBrown_leaf.png",
    "/tank/Retina/treeGreen_twigs.png",
    "/tank/Retina/treeBrown_twigs.png",
    "/tank/Retina/oilSpill_small.png",
    "/tank/ices/iceBlock.png",
    "/tank/ices/iceBlockAlt.png",
    "/tank/snow-map/tundraCenter.png",
    "/tank/snow-map/tundraCenter_rounded.png",
    "/tank/rails/railVertical1.png",
    "/tank/rails/railVertical2.png",
    "/tank/rails/railVertical3.png",
    "/tank/rails/railHorizontal1.png",
    "/tank/rails/railHorizontal2.png",
    "/tank/rails/railHorizontal3.png",
    "/tank/rails/railHorizontal4.png",
    "/tank/monster/tile_0108.png",
    "/tank/monster/tile_0109.png",
    "/tank/monster/tile_0121.png",
    "/tank/items/heart-hp.png",
    "/tank/items/shield.png",
    "/tank/trap_scope.png",
    "/tank/Retina/barrelRed_top.png",
    "/tank/Retina/shotOrange.png",
    "/tank/Retina/shotRed.png",
    "/tank/Retina/bulletDark1_outline.png",
    ...roadNames.flatMap((n) => [`/tank/Retina/tileGrass_road${n}.png`, `/tank/Retina/tileSand_road${n}.png`]),
    ...skins.flatMap((s) => [`/tank/Retina/tankBody_${s}.png`, `/tank/Retina/tank_${s}.png`]),
    ...["Blue", "Dark", "Green", "Red", "Sand"].flatMap((s) => [`/tank/Retina/tank${s}_barrel1.png`, `/tank/Retina/bullet${s}1_outline.png`]),
    ...EXPLOSION_FRAMES,
    ...PLANE_FRAMES,
    ...FALLING_BOMB_FRAMES,
    ...BOMB_EXPLOSION_FRAMES,
