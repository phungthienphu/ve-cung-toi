...
function preloadTankSprites() {
  ...
  const srcs = [
    ...
    "/snow-map/tundraCenter.png",
    "/snow-map/tundraCenter_rounded.png",
    "/rails/railVertical1.png",
    "/rails/railVertical2.png",
    "/rails/railVertical3.png",
    "/rails/railHorizontal1.png",
    "/rails/railHorizontal2.png",
    "/rails/railHorizontal3.png",
    "/rails/railHorizontal4.png",
